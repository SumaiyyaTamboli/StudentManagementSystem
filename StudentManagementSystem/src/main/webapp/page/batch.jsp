  ...
  <div class="w-50 align-middle border border-info  border-3 mt-2" 
   ...
   <div class="border border-secondary m-3 p-2"> 
      ...
      <tbody> 
        ...
        <label for="batchNumber" class="text-info"><b>Enter Batch Number<br> 
</b></label> 
        <input type="number" name="batchNumber"  > 
         <label for="batchMode" class="text-info"><b>Enter Batch Mode<br> 
</b></label> 
        <input type="text" name="batchMode"  > 
        <
        </div> 
         <div class="d-flex justify-content-center pt-5"> 
        <button class="btn btn-success btn-sm ">Add Batch Number</button>
          </div> 
        </form> 
